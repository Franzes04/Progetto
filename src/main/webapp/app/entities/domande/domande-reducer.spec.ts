...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './domande.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOMANDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOMANDE actions', async () => {
      const expectedActions = [
        {
