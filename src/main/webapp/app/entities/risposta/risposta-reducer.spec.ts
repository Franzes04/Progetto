...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './risposta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RISPOSTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_RISPOSTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RISPOSTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RISPOSTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RISPOSTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RISPOSTA actions', async () => {
      const expectedActions = [
        {
